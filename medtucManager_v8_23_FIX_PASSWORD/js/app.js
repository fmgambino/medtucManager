...
(function(){
  ...
  window.openForm = async function(key,id=null){
    ...
    if(!value) return;
    try{
      const payload={ p_id:id||null, p_email:value.email, p_full_name:value.full_name, p_role_name:value.role_name||'Usuarios', p_office:value.office||null, p_phone:value.phone||null, p_is_active:value.is_active, p_password:value.password||null };
...
(function(){
  ...
  window.openForm = async function(key,id=null){
    if(key==='users'){
      ...
      if(!value)return;
      const payload={p_id:id||null,p_email:value.email,p_full_name:value.full_name,p_role_name:value.role_name,p_office:value.office||null,p_phone:value.phone||null,p_is_active:value.is_active,p_password:value.password||null};
