...
serve(async (req) => {
  ...
  try {
    ...
    // CLAVE DEL FIX:
    // Para editar contraseña/perfil de usuarios ya existentes usamos el ID enviado por la PWA.
    // No usamos listUsers ni createUser si ya hay id, porque tu proyecto está fallando en Auth al buscar/validar emails.
    if (!userId) {
