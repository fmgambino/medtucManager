const demoAccounts = {
  superadmin: { user:'fernando.m.gambino@gmail.com', password:'Jamboree0342$$', name:'Ing Gambino', email:'fernando.m.gambino@gmail.com', role:'SuperAdmin', role_code:'superadmin', avatar_url:'./assets/avatar-default.svg' },
  admin: { user:'admin', password:'admin123', name:'Administrador General', email:'admin@ism.edu.ar', role:'Administrador', avatar_url:'./assets/avatar-default.svg' },
  docente: { user:'docente', password:'docente123', name:'María López', email:'mlopez@ism.edu.ar', role:'Tecnico', avatar_url:'./assets/avatar-default.svg' },
  alumno: { user:'alumno', password:'alumno123', name:'Thiago Benjamín Luna', email:'thiago.luna@ism.edu.ar', role:'Usuario', avatar_url:'./assets/avatar-default.svg' }
};
