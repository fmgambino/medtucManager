...
(function(){
  ...
  function normalizeRole830(v){
    const r = String(v || 'Usuarios').trim();
    if(r === 'Referentes') return 'Referente';
    return r;
  }

  function roleName(){
    return normalizeRole830(state.profile?.role_name || 'Usuarios');
  }
...
window.buildReferenteDashboard830 = function(){
  return `
  <div class="cards-grid referente-dashboard">
    <div class="card stat-card">
      <div class="stat-title">Mis Tickets</div>
      <div class="stat-value" id="refTicketsCount">0</div>
      <div class="stat-sub">Tickets generados por su oficina</div>
    </div>

    <div class="card stat-card">
      <div class="stat-title">Órdenes vinculadas</div>
      <div class="stat-value" id="refOrdersCount">0</div>
      <div class="stat-sub">Órdenes relacionadas</div>
    </div>

    <div class="card stat-card">
      <div class="stat-title">Pendientes</div>
      <div class="stat-value" id="refPendingCount">0</div>
      <div class="stat-sub">Tickets sin resolver</div>
    </div>
  </div>`;
};
