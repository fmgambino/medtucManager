...
create function public.admin_upsert_profile_by_email(
  p_email text,
  p_full_name text,
...
create function public.ensure_current_user_profile()
returns void
language plpgsql
security definer
set search_path = public, auth
...
create function public.admin_create_inventory_asset(
  p_name text,
